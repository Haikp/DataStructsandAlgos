...
void createBinTree(binTree<visibilityType>&, vector<visibilityType>&, int);
...
int main(int argc, char *argv[])
{
    ...
    for (int i = 0; i < totalCases; i++)
    {
        ...
        createBinTree(constructTree, caseValues, i);
    }
...
void createBinTree(binTree<visibilityType>& constructTree, vector<visibilityType>& caseValues, int i)
{
